...
<div>
    ...
    $query="select * from data WHERE `user_email` = '".$user['email']."' ";
  ...
  width: 55%;
       ...
       echo '<a  href="play.php?name='.$row['type'].'  & audio_id='.$row['audio_id'].'  & user_email='.$user['email'].'">'.$row['type'].'</a>';
       echo "</p>";
...
<div class='title'>
    <a href="index.php?id=<?php echo $Result->ad_id();?>"><?php echo ucwords($Result->ad_title);?></a>
</div>
id=<?php echo $ido;?>